...
$.Velocity
    ...
    .RegisterEffect( "self_transition.slideDownIn",{
        calls: [
            [ { opacity: [ 1, 1 ],translateY:[0,300]},3,{easing:'linear'}],
            [ { opacity: [ 1, 1 ]},registerTime]
        ]
    })
    .RegisterEffect( "self_transition.slideDownSpecialIn",{
        calls: [
            [ { opacity: [ 1, 0 ],translateY:[0,150]},3,{easing:'linear'}],
            [ { opacity: [ 1, 1 ]},registerTime]
        ]
    })
    .RegisterEffect( "transition.slideDownLongIn",{
        calls: [
            [ { opacity: [ 1, 1 ],translateY:[0,500]},3,{easing:[.08,1.04,.78,.84]}],
            [ { opacity: [ 1, 1 ]},registerTime]
        ]
    })
    ...
    .RegisterEffect( "self_transition.slideUpIn", {
        calls: [
            ...
            [ {opacity: [ 1, 0 ],translateY:[0,'85%']},3,{easing:'linear'}],
        ]
    ...
    .RegisterEffect( "self_transition.slideDownScaleIn", {
        calls: [
            [ { scaleX: [1,0.5], scaleY: [1,0.5] ,opacity:[1,0],translateY:[0,"100%"]} ,3,{easing:'linear'} ],
            [ { scaleX: 1, scaleY: 1 }, registerTime]
        ]
    })
    ...
    .RegisterEffect( "self_transition.meteorForthIn", {
        calls: [
    ...
    .RegisterEffect( "self_transition.jumpIn", {
        calls: [
            ...
            [ {  scaleX:[1,1.1],scaleY:[1,1.1],translateZ:[0,300],translateY:[0,100] },0.75,{easing:"linear"}],
            [ { opacity: 1}, registerTime ]
        ],
    ...
    .RegisterEffect( "self_transition.boatIn", {
        calls: [
            [ { opacity: [ 1, 0], scaleX:[1,0],scaleY:[1,0],translateX: [0,'-350%'],translateY:[0,'-10%']},3 ,{easing:'linear'}]
        ],
        reset: { opacity:1}
    })
    .RegisterEffect( "self_transition.boat1In", {
        calls: [
            [ { opacity: [ 1, 0], scaleX:[1,0],scaleY:[1,0],translateX: [0,'350%'],translateY:[0,'-10%']},3 ,{easing:'linear'}]
        ],
        reset: { opacity:1}
    })
    .RegisterEffect( "self_transition.infoIn", {
    calls: [
        [ { opacity: [ 1, 0 ], scaleX: [ 1.05, 0.3 ], scaleY: [ 1.05, 0.3 ] }, 2,{easing:[.17,.67,.83,.67]} ],
        [ { scaleX: 0.9, scaleY: 0.9, translateZ: 0 }, 0.20 ],
        [ { scaleX: 1, scaleY: 1 }, 3],
        [ { scaleX: 0, scaleY: 0,opacity:0 }, 1],
    ],
    reset: { opacity:1}
})
    .RegisterEffect( "self_transition.slideDropSpecialIn",{
    calls: [
        [ { opacity: [ 1, 0 ] ,translateX:[0,"-0%"],scaleX:[1,5],scaleY:[1,5],translateY:[0,'-700%']} ,1,{ easing: [.68, -.55, .265, 1.55]}],
        [ { opacity: [ 1, 1 ]},registerTime]
    ],
    reset:{translateX:0}
})
    .RegisterEffect( "self_transition.slidenoDownIn",{
        calls: [
            [ { opacity: [ 1, 1 ],translateY:[-100,300],translateX:[50,0]},3,{easing:'linear'}],
            [ { opacity: [ 0, 1],scaleX:[0,1],scaleY:[0,1]},3],
            [ { opacity: [ 0, 1 ]},registerTime]
        ],
        reset: {opacity:0,translateY:0,translateX:0,scaleX:1,scaleY:1}
    })
    .RegisterEffect( "self_transition.slideno1DownIn",{
        calls: [
            [ { opacity: [ 1, 1 ],translateY:[0,300],translateX:[50,0]},3,{easing:'linear'}],
            [ { opacity: [ 0, 1],scaleX:[0,1],scaleY:[0,1]},3],
            [ { opacity: [ 0, 0 ]},registerTime]
        ],
        reset: { opacity:0,translateY:0,translateX:0,scaleX:1,scaleY:1}
    })
    .RegisterEffect( "self_transition.slideBigYIn",{
        calls: [
            [ {transformOriginY: [ "0%", "0%" ]}],
            [ { opacity: [ 1, 0 ],scaleY:[1,0]} ,3,{ easing: 'linear'}],
            [ { opacity: [ 1, 1 ]},registerTime]
        ],
        reset:{ opacity:1,translateY:0,translateX:0,scaleX:1,scaleY:1,transformOriginY:'50%'}
    })
;
