...
$.Velocity
    ...
    .RegisterEffect( "self_transition.slideLeftDownScaleIn",{
        calls: [
            [ { opacity: [ 1, 0 ],translateX:[0,-500],translateY:[0,500],scaleX:[1,0.2],scaleY:[1,0.2]},2,{easing:[.455, .03, .515, .955]}],
            [ { opacity: [ 1, 1 ]},.5]
        ]
    })
    .RegisterEffect( "self_transition.slideLeftScaleSpecialIn",{
        calls: [
            [ { opacity: [ 1, 0 ] ,translateX:[0,"-400%"],scaleX:[1,3],scaleY:[1,3],translateY:[0,'100%']} ,3,{ easing: [.68, -.55, .265, 1.55]}],
            [ { opacity: [ 1, 1 ]},registerTime]
        ],
        reset:{translateX:0}
    })
